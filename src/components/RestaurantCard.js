    ...
    return (
      <div className='transition-transform transform hover:scale-95'>
        <div className='relative overflow-hidden rounded-lg'>
          <img className='rounded-2xl w-[325px] h-[190px] object-cover' src={"https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/" + cloudinaryImageId} alt="food-image" />
