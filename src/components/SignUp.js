...
const SignUp = () => {
    ...
    function submitHandler(e) {
        e.preventDefault();
        toast.success(` Welcome to FoodFest ${formData.Username}`); 
  ...
  return (
    <div className="flex justify-center mb-10 mt-10">
        <form onSubmit={submitHandler}
            ...
            <button class="bg-slate-600 py-[8px] px-[12px] rounded-[8px] mt-6 font-medium text-lg text-slate-100 w-11/12 ml-5 mb-5 ">
                Sign Up
            </button>
        </form>
